  ...
  return Align(
    ...
    child: Padding(
      ...
      child: Row(
        ...
        children: [
          glassContainer(
            width: (screen_width > 600) ? 300 : 0.7 * screen_width,
            height: (screen_width > 600) ?68 : 60,
            child: Row(
  ...
  return InkWell(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(28),
        border: selected
            ? Border.all(color: BG.withAlpha(29))
            : null,
      ),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
